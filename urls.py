...
cismp_patterns = [
    ...
    path('information_security_principles/', CismpRandomModuleView.as_view(modules = (cismp_1,)), name = 'information_security_principles'),
    path('information_risk/', CismpRandomModuleView.as_view(modules = (cismp_2,)), name = 'information_risk'),
    path('information_security_frameworks/', CismpRandomModuleView.as_view(modules = (cismp_3,)), name = 'information_security_frameworks'),
    path('security_life_cycles/', CismpRandomModuleView.as_view(modules = (cismp_4,)), name = 'security_life_cycles'),
    path('procedural_and_people_security_controls/', CismpRandomModuleView.as_view(modules = (cismp_5,)), name = 'procedural_and_people_security_controls'),
    path('technical_security_controls/', CismpRandomModuleView.as_view(modules = (cismp_6,)), name = 'technical_security_controls'),
    path('physical_and_environmental_security/', CismpRandomModuleView.as_view(modules = (cismp_7,)), name = 'physical_and_environmental_security'),
    path('disaster_recovery_and_business_continuity_management/', CismpRandomModuleView.as_view(modules = (cismp_8,)), name = 'disaster_recovery_and_business_continuity_management'),
    path('cryptography/', CismpRandomModuleView.as_view(modules = (cismp_9,)), name = 'cryptography'),
    path('log_problem/', log_problem, name='log_problem'),
] 
...
jimmy_patterns = [
    path('', JimmyHomeView.as_view(), name='jimmy_home'),
    path('random/', JimmyRandomModuleView.as_view(modules = (_1_antennas,)), name = 'jimmy_random'),
    #path('information_security_principles/', CismpRandomModuleView.as_view(modules = (cismp_1,)), name = 'information_security_principles'),
    path('log_problem/', log_problem, name='log_problem'),
]
...
urlpatterns = [
    ...
    path('jimmy/', include(jimmy_patterns)),
    
]

pi_patterns = [
    path('', PIHomeView.as_view(), name='python_institute_home'),
    path('log_problem/', log_problem, name='log_problem'),
]
