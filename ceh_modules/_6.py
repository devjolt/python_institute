...
('non-electronic attacks',['shoulder surfing', 'social engineering', 'dumptster diving', 'no technical knowledge needed', 'non-technical attack']),
('active online attacks', ['dictionary attacks', 'brute forcing', 'rule based attack','hash injection attack', 'LLMNR/NBT poisoning', 'trojan', 'spyware', 'keyloggers', ''password guessing', 'internal monologue attack', 'cracking Kerbos passwords', 'communicating drectly with a victim's machine'])
